...
from attnClasses import BidirectEncoder, AttnDecoder, Seq2Seq
...
def main():
    ...
    train_input_lang, train_output_lang, train_pairs = prepareData('train', 'ar', 'eng', reverse=False, reverse_source=False)
    valid_input_lang, valid_output_lang, valid_pairs = prepareData('valid', 'ar', 'eng', reverse=False, reverse_source=False)
    test_input_lang, test_output_lang, test_pairs = prepareData('test', 'ar', 'eng', reverse=False, reverse_source=False)
    ...
    hidden_size = 50
    encoder = BidirectEncoder(train_input_lang.n_chars, hidden_size)
    decoder = AttnDecoder(hidden_size, train_output_lang.n_chars, train_input_lang.biggest_word)
